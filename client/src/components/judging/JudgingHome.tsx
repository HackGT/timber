...
const JudgingHome: React.FC<Props> = props => {
  ...
  const [{ data: assignmentsData, loading: assignmentsLoad, error: assignmentError }] = useAxios("/assignments");
...
if (nextProjectID) {
  next = <h3>The next project is {nextProjectName} at table number: {nextTableNumber} in table group: {nextTableGroupName}.</h3>
} 
